...
from util.util import cal_aleatoric_uncertainty
...
class UACycleGANModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        if self.isTrain:  # define discriminators
            ...
            if load_pretrain == True:
                ...
                # print(filtered_Init_netD_A_dict.keys())
                # print(' ')
                # print(filtered_Init_netD_B_dict.keys())
    ...
    def forward(self):
        ...
        self.ua_B = cal_aleatoric_uncertainty(self.fake_alpha1_B, self.fake_alpha2_B, self.fake_beta_B)
        self.ua_A = cal_aleatoric_uncertainty(self.fake_alpha1_A, self.fake_alpha2_A, self.fake_beta_A)
    ...
    def backward_G(self):
        ...
        self.loss_cycle_A = self.criterionCycle(self.rec_A, self.rec_alpha1_A, self.rec_alpha2_A, self.rec_beta_A, self.real_A) * lambda_A / 2 # /5 not good
        # Backward cycle loss || G_A(G_B(B)) - B||
        self.loss_cycle_B = self.criterionCycle(self.rec_B, self.rec_alpha1_B, self.rec_alpha2_B, self.rec_beta_B, self.real_B) * lambda_B / 2 
        # combined loss and calculate gradients
